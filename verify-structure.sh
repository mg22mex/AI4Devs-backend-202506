...
echo "🎨 Components: 5 main components"
echo "🏗️  Techniques: 11 construction techniques supported"
echo ""
echo "Supported techniques:"
echo "  • Adobe, Cob, Superadobe"
echo "  • Bahareque, Pacas de Paja, Bambú"
echo "  • Piedra, Botellas de Vidrio"
echo "  • Tapia/Tapial, Tierra-Paja, Madera"
echo ""
