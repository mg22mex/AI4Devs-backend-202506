...
echo "🏗️  Construction Techniques: 27"
...
echo "  Agua/Permacultura: Cosecha de Agua, Aguas Grises, Estanques, Permacultura, Curvas de Nivel"
echo "  Biofilia: Jardines Interiores, Muros Verdes"
echo ""
